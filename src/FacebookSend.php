...
class FacebookSend
{
    ...
    protected $handOverUrl = "https://graph.facebook.com/v2.6/me/pass_thread_control";
    protected $log;
    ...
    public function handOverToHuman(string $accessToken, string $senderId)
    {
        $jsonDataEncoded = $this->facebookPrepareData->handToHuman($senderId);

        $url = $this->handOverUrl . '?access_token=' . $accessToken;
        $ch = curl_init($url);
